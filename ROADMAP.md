...
36. **Exercise-type variety is narrow across nearly all A1/A2 lessons** — 132/154 A1 and 132/174 A2 lesson-parts use only 4 exercise types, never mixing in `dialogue-complete`, `sentence-order`, `listening-choice`, `dictation`, or `structured-writing`. Decision needed: backfill variety across existing lessons, or treat 5+ types as aspirational for new content only.
