...
94. **Rewrite the B1 Unit 1 exercises (added 2026-09-25).** `content/es-latam` and `content/es-es` `exercises/b1/b1-01-*-ex.json` (identical in both courses) look machine-templated. `b1-01-consolidation` repeats the same fill-blank, sentence-builder, matching, dialogue and listening items three times each. Its sentence-builders give the tiles already in solution order. Its dialogue is a generic "¿Qué sabes sobre el tema?" / "Entiendo.", and the listening options are generic ("The sentence expresses the main idea."). In `b1-01-01` to `05`, the grammar multiple-choice questions quote the correct answer inside the question ("Elige la opción que mejor encaja en «Ya había salido.»") next to a fixed "La historia ocurre mañana." distractor. The three blank placeholders were rewritten (ACHIEVED.md item 93); the rest of the unit needs the same care. Check whether other early B1 units share the template.
