...
- [ ] **Canon underuse (not fixed, needs new authoring rather than a bug fix)**: none of the 30 readings currently mention Anna's one-year-old baby, András working as a teacher, or Meg's twin sisters Kaylee and Lauren by name/location (Johannesburg) — Unit 6 gestures at "her two younger sisters happen to be twins" but never names them. The family relationships that *are* used (Anna as older sister, András as younger brother, Mariann as a teacher who "tanít" in Unit 13) are consistent with canon, just thin. Weaving in these specifics would need deliberate rewrites of specific units (Unit 6 "Family" and Unit 29 "Hobbies & Free Time" are the natural homes for Anna's baby and András's job respectively) rather than a corpus-wide sweep — flagging for a future content pass.
