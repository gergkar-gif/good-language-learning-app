...
- [ ] Add a "back to previous exercise" button during lessons.
- [ ] Opening the lesson tree/map shouldn't require scrolling to find the current lesson — it should auto-scroll/open directly there.
