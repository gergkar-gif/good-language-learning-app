...
- [ ] Unit 10 overall needs a full review: too much writing, too little active practice. Prioritize teaching how to conjugate "saber" and basic connectors (y, con, sin, pero) over incidental vocabulary like "vela" and "globo". *(still not addressed — needs a product decision on curriculum reordering/rebalancing, not a content fix. The numbers-sequencing gap that motivated this item is now resolved on its own, per above, but the broader too-much-writing/wrong-vocab-priority critique stands.)*
