...
**Status as of 2026-08-28: Units 1-8 (all forty teaching lessons)
...
`lesson.b1.independencia.01-05` — each with its own dedicated story, not
a story shared across the unit; grammar, vocabulary, exercises and
...
§7's Latin America override describes). All 28 other Latin America units
