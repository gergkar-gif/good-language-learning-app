...
**Status as of 2026-08-28: Units 1-4 (all twenty teaching lessons)
rebuilt to this model** (`lesson.b1.precolombina.01-05`,
`lesson.b1.civilizaciones.01-05`, `lesson.b1.llegadaeuropeos.01-05`,
`lesson.b1.conquista.01-05` — each with its own dedicated story, not a
...
§7's Latin America override describes). All 32 other Latin America units
