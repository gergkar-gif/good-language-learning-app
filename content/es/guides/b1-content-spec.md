...
**Status as of 2026-08-28: Units 1-5 (all twenty-five teaching lessons)
rebuilt to this model** (`lesson.b1.precolombina.01-05`,
`lesson.b1.civilizaciones.01-05`, `lesson.b1.llegadaeuropeos.01-05`,
`lesson.b1.conquista.01-05`, `lesson.b1.sociedadcolonial.01-05` — each
with its own dedicated story, not a story shared across the unit;
...
describes). All 31 other Latin America units still follow the original
